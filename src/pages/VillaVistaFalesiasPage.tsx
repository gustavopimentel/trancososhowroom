...
import sliderNormal1 from '@/assets/images/villavista-falesias/Slider Falesias.jpg'
import sliderNormal2 from '@/assets/images/villavista-falesias/Slider Falesias 2.jpg'

// Importar imagens do slider - Tracejado
import sliderTracejado1 from '@/assets/images/villavista-falesias/Slider Falesias tracejada.jpg'
import sliderTracejado2 from '@/assets/images/villavista-falesias/Slider Falesias 2 TRacejado.jpg'

// Importar imagens do slider - Lente
import sliderLente1 from '@/assets/images/villavista-falesias/Slider Falesias lente.jpg'
import sliderLente2 from '@/assets/images/villavista-falesias/Slider Falesias 2 Lente.jpg'

// Importar logo e grafismo
import logo from '@/assets/images/villavista-falesias/Logo Villavista Falesias full dourado.png'
import grafismo from '@/assets/images/villavista-falesias/grafismo.png'

type SlideType = 'normal' | 'tracejado' | 'lente'

const slideImages: Record<SlideType, string[]> = {
  normal: [sliderNormal1, sliderNormal2],
  tracejado: [sliderTracejado1, sliderTracejado2],
  lente: [sliderLente1, sliderLente2],
}
  ...
  if (images.length === 0) {
    return (
      <div className="w-full h-full flex items-center justify-center bg-gray-100">
        <p className="text-gray-400 font-sans">Adicione as imagens na pasta villavista-falesias</p>
      </div>
    )
  }
...
export function VillaVistaFalesiasPage() {
        ...
        <div className="flex flex-col h-full px-12 pt-16 pb-8">
          ...
          >
            <p className="text-[0.9375rem] font-sans text-gray-800 leading-relaxed text-justify">
              Villavista Falésias é um raro encontro entre a natureza intocada e a exclusividade absoluta. Situado na primeira linha em relação ao Atlântico, no ponto mais privilegiado do Complexo Terravista, cada lote foi cuidadosamente posicionado para oferecer vistas permanentes: o azul profundo do oceano, o verde vibrante do campo de golfe e as imponentes falésias que fazem deste um lugar único.
            </p>
          </motion.div>

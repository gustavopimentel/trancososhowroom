...
import sliderNormal1 from '@/assets/images/villavista-campo/Slider Campo.jpg'

// Importar imagens do slider - Tracejado
import sliderTracejado1 from '@/assets/images/villavista-campo/Slider Campo Tracejado.jpg'

// Importar imagens do slider - Lente
import sliderLente1 from '@/assets/images/villavista-campo/Slider Campo Lente.jpg'

// Importar logo e grafismo
import logo from '@/assets/images/villavista-campo/Logo Vilavista Campo Full Dourado.png'
import grafismo from '@/assets/images/villavista-campo/grafismo.png'
  ...
  if (images.length === 0) {
    return (
      <div className="w-full h-full flex items-center justify-center bg-gray-100">
        <p className="text-gray-400 font-sans">Adicione as imagens na pasta villavista-campo</p>
      </div>
    )
  }
...
export function VillaVistaCampoPage() {
        ...
        <div className="flex flex-col h-full px-12 pt-16 pb-8">
          ...
          >
            <p className="text-[0.9375rem] font-sans text-gray-800 leading-relaxed text-justify">
              Villavista Campo traduz o ritmo de Trancoso em sua essência. Rodeado por lagos tranquilos, o verde impecável do campo de golfe e a exuberância da vegetação nativa, cada lote é um convite a uma experiência de vida integrada à paisagem.
            </p>
            <p className="text-[0.9375rem] font-sans text-gray-800 leading-relaxed text-justify mt-4">
              As alamedas, desenhadas para garantir privacidade, conduzem os moradores por percursos que transformam cada trajeto em um momento de imersão na natureza. Um refúgio perfeito para quem busca a exclusividade que só o Condomínio Villavista pode oferecer.
            </p>
          </motion.div>
